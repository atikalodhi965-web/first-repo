...
import tokenApiRouter from './routes/token/tokenApis';
import userProfileRouter from './routes/user/userProfileRoutes';
import userAuthRouter from './routes/auth/userAuthRoutes';
import otpRouter from './routes/auth/otpRoutes';
import referralRouter from './routes/referralRoutes';
import walletRouter from './routes/walletRoutes';
import socialAuthRouter from './routes/auth/socialAuthRoutes';
...
app.use('/api/otpRoutes', otpRouter);
app.use('/api/tokenapis', tokenApiRouter);
app.use('/api/user', userProfileRouter);
app.use('/api/auth/custom', userAuthRouter);
